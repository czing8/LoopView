...
@property (nonatomic, strong)   V3CyclePicPlayer *cycle1PicPlayer;
...
- (void)displayVCyclePlayer{
    ...
    self.cycle1PicPlayer = [[V3CyclePicPlayer alloc] initWithImageUrls:urls autoTimerInterval:3 click:^(NSInteger index) {
    ...
    V3CyclePicPlayer *banner2 = [[V3CyclePicPlayer alloc] initWithImageNames:@[@"image1", @"image2"] autoTimerInterval:2 click:^(NSInteger index) {
